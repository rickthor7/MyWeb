...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Perkiraan cuaca (bukan dukun) wkwk" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 3,
                image: "https://media.istockphoto.com/photos/selective-focus-photo-of-graphic-designer-picture-id1015393742?k=20&m=1015393742&s=612x612&w=0&h=tEvmQg5ck5V2Tu-84Y3NSQr1UuMEpsyfu78MrF9Ig8c=",
                label: "Desain",
                name: "Gradasi Generator"
            }, {
                icon: "fa-solid fa-pen-nib",
                id: 4,
                image: "https://media.istockphoto.com/photos/design-tools-top-view-of-a-designer-using-graphic-tablet-and-working-picture-id1194380325?k=20&m=1194380325&s=612x612&w=0&h=nCCxhBCEUDkuCsTkZy6FghHwxEODLIt1M_kYX1PraBE=",
                label: "desain",
                name: "SVG art generator"
            }, {
                ...
                id: 6,
                image: "https://media.istockphoto.com/vectors/message-bubbles-vector-id1245805477?k=20&m=1245805477&s=612x612&w=0&h=VdvOIoukVwjyf5ZtPznyU2gpWsnTo4zF4cFoHp4SCTM=",
                label: "mampir!",
                name: "Bot Chat",
                link: "rickthor7.my.id",
            }].map((tool) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Tools Online" }, getTools()));
};
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Tips dan trik terbaru seputar dunia teknologi",
                id: 1,
                image: "https://images.unsplash.com/photo-1504639725590-34d0984388bd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",
                title: "Tips&Trik"
            }, {
                desc: "Mengambil alih & mengubah tampilan website",
                id: 2,
                image: "https://media.istockphoto.com/photos/hacker-attacking-internet-picture-id540848970?k=20&m=540848970&s=612x612&w=0&h=O0Zq7j3fjxCl1l1_9VWjKZVqUz7QSUtv7hb9kfKEQgE=",
                title: "Defacing"
            }, {
                desc: "Dari membuat website hingga membuat program",
                id: 3,
                image: "https://media.istockphoto.com/photos/cyber-security-it-engineer-working-on-protecting-network-against-picture-id1322517295?k=20&m=1322517295&s=612x612&w=0&h=lWRL-TWWGuWOxh1ZVJPmzjnBSBHX3RboPyJoG7OXhYc=",
                title: "Coding"
            }, {
                desc: "Mulai dari CCTV hingga membuat backdoor",
                id: 4,
                image: "https://media.istockphoto.com/photos/dangerous-hooded-hacker-breaks-into-government-data-servers-and-a-picture-id817486228?k=20&m=817486228&s=612x612&w=0&h=dDx-RO7ntH3C_BWxEQrCj9hrp9pFegpXuHGSTgImt3E=",
                title: "Hacking"
            }].map((restaurant) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Artikel terbaru gaes!" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "Hacker action keren cewenya spek korea wkwk.",
                id: 1,
                icon: "fa-solid fa-galaxy",
                image: "https://www.jagatreview.com/wp-content/webp-express/webp-images/uploads/2015/01/blackhat-poster-500x792.jpg.webp",
                title: "BlackHat"
            }, {
                ...
                image: "https://is4-ssl.mzstatic.com/image/thumb/Video126/v4/19/5e/af/195eaf73-bf2a-74ac-e023-5717fe608b7f/pr_source.lsr/1600x900.webp",
                title: "War Games"
            }].map((movie) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "movies-section", scrollable: true, title: "Film Favorit" }, getMovies()));
};
